...
public class FactLogin {
	static JFrame frm;
	private JTextField textField;
	private JPasswordField passwordField;
	public FactLogin()
	{
		frm=new JFrame("Faculty Login");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
					...
					try {
						...
						PreparedStatement st=con.prepareStatement("select userid,pswd from facultylog where userid=? and pswd=?");
						st.setString(1,uid);
						st.setString(2,pswd);
